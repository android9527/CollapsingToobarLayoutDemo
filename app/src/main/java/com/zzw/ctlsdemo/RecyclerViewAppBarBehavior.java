...
public final class RecyclerViewAppBarBehavior extends AppBarLayout.Behavior
{
    ...
    private Map<RecyclerView, RecyclerViewScrollListener> scrollListenerMap = new HashMap<RecyclerView, RecyclerViewScrollListener>(); //keep scroll listener map, the custom scroll listener also keep the current scroll Y position.
